...
func TestRequestLineParse(t *testing.T) {
	...
	// Test: Good GET Request line with path with chunk reader minBytesPerRead
	reader := &chunkReader{
		data:            "GET /coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 1,
	}
	...
	// Test: Good GET Request line with path with chunk reader maxBytesPerRead
	reader = &chunkReader{
		data:            "GET /coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: len([]byte("GET /coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n")),
	}
...
func TestParseHeaders(t *testing.T) {
	...
	headers := h.Headers{"host": "samplehost:9000"}
	data := []byte("Host: localhost:42069\r\n\r\n")
	err = headers.Parse(string(data))
	require.NoError(t, err)
...
func TestHeaderParsing(t *testing.T) {
	...
	fmt.Println(RequestFromReader(reader))
}
...
func TestParseBody(t *testing.T) {
	...
	// Test: Body Present but no Content-Length
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"\r\n" +
